...
namespace ToDoList2.Controllers
{
    public class ToDoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Opis,IsDone")] ToDo toDo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AJAXCreate([Bind(Include = "Id,Opis")] ToDo toDo)
        {
            if (ModelState.IsValid)
            {
                string currentUserId = User.Identity.GetUserId();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Opis,IsDone")] ToDo toDo)
        {
            if (ModelState.IsValid)
            {
